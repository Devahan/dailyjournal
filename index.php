...
<html lang="en">
  ...
  <body>
    <!-- nav begin -->
        ...
        <div class="container">
            <a class="navbar-brand" href="#">Hysilens</a>
...
<!-- article end -->
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExample" data-bs-slide="next">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-8">
                                    <div class="bg-primary bg-opacity-10 p-4 rounded-3 mb-4">
                                        <h3 class="fw-bold text-primary mb-2">Deva Hanung Ichtiarsa</h3>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-7">
                                                <span>: 111202415570@mhs.dinus.ac.id</span>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-5">
    ...
    <footer class="text-center p-5 bg-secondary-subtle">
        <div>
            <a href="https://www.instagram.com/devahanung" class="text-decoration-none me-3">
                <i class="bi bi-instagram h3"></i>
            </a>
            <a href="https://wa.me/+6287879993402" class="text-decoration-none">
