...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" target="_blank" href=".">Hysilens</a>
        <button
    ...
    <div class="container">
        ...
        ?>
            <h4 class="lead display-6 pb-2 border-bottom border-secondary-subtle">Dashboard</h4>
            <?php
    ...
    <div>
        <a href="https://www.instagram.com/devahanung"
        ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://twitter.com/udinusofficial"
        ><i class="bi bi-twitter h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/+6287879993402"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>Deva Hanung Ichtiarsa &copy; 2025</div>
    </footer>
    <!-- footer end -->
    <script
